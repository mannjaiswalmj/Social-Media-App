...
class PostAdapter(options: FirestoreRecyclerOptions<Post>, val listener: IPostAdapter, val listener2: IDeleteAdapter) : FirestoreRecyclerAdapter<Post,PostAdapter.PostViewHolder>(
    options
){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PostViewHolder {
        ...
        viewHolder.deleteButton.setOnClickListener{
            listener2.onDeleteClicked(snapshots.getSnapshot(viewHolder.adapterPosition).id)
        }
        return viewHolder
    }
